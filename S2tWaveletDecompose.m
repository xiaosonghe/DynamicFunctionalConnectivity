% DO THIS UNDER R2014 with WMTSA toolbox (https://atmos.washington.edu/wmtsa/)
...
clear all;
sbj = importdata('E:\VerbGeneration_network\sbj.txt'); % List of your subjects
...
for s=1:length(sbj)
    ...
    D2=squeeze(modDt(:,2,:));     % Select the second bandpath (0.05~0.1)
    D3=squeeze(modDt(:,3,:));     % Select the third bandpath (0.025~0.05)
    % save the components
    save(['E:\VerbGeneration_network\5tDecomposedSignals\' sbj{s} '.mat'],'D2','D3');
end
